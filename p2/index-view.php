...
<body class="bg-slate-50 text-lg">
    ...
    <section
        ...
        <div class="flex-1 min-w-[60%] md:min-w-[80%] p-4">
            ...
            <ul class="list-disc pb-2 pl-6">
                <li>Game Winner: <?php echo $winner ?>
                </li>
            ...
            <form class="bg-[#ffdb6d]/90 p-4" method='POST' action='process.php'>
                <fieldset>
                    ...
                    <select name="maxRounds" id="max-rounds">
                        <option value="5"
                            <?php echo ((isset($_SESSION['maxRounds'])) and ($_SESSION['maxRounds'] == "5")) ? 'selected' : '' ?>>
                            5
                        </option>
                        <option value="10"
                            <?php echo ((isset($_SESSION['maxRounds'])) and ($_SESSION['maxRounds'] == "10")) ? 'selected' : '' ?>>
                            10
                        </option>
                        <option value="25"
                            <?php echo ((isset($_SESSION['maxRounds'])) and ($_SESSION['maxRounds'] == "25")) ? 'selected' : '' ?>>
                            25
                        </option>
                        <option value="50"
                            <?php echo ((isset($_SESSION['maxRounds'])) and ($_SESSION['maxRounds'] == "50")) ? 'selected' : '' ?>>
                            50
                        </option>
                        <option value="100"
                            <?php echo ((isset($_SESSION['maxRounds'])) and ($_SESSION['maxRounds'] == "100")) ? 'selected' : '' ?>>
                            100
                        </option>
                        <option value="500"
                            <?php echo ((isset($_SESSION['maxRounds'])) and ($_SESSION['maxRounds'] == "500")) ? 'selected' : '' ?>>
                            500
                        </option>
                        <option value="">Reset
                        </option>
